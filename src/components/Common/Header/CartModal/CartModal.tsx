      ...
      {isOpen && (
        <div className="cart-modal">
          <div className="cart-modal__header">
            <h2 className="cart-modal__title">MY ORDER</h2>
            {cartItems.length > 0 && (
          ...
          <div className="cart-modal__items-container">
              ...
              <div className="cart-modal__empty">
                ...
                {cartItems.map((item) => (
                  ...
                  <div className="cart-modal__item-details">
                    ...
                    <span className="cart-modal__item-currency">₪</span>
            ...
            <div className="cart-modal__total">
              <p>TOTAL - <span className="cart-modal__currency">₪</span>{calculateTotal()}</p>
            </div>
